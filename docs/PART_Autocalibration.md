...
1. Download [the latest autocalibration build](https://bgcgamefiles.s3.us-east-2.amazonaws.com/PART/Builds/Test/PART_PodAutocalibration27.zip) and extract it on the PC you wish to use.
